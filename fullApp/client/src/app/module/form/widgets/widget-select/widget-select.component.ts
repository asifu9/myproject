...
import { WidgetMetaData, Options } from "../../../shared/shared/models";
...
export class WidgetSelectComponent extends WidgetBase implements OnInit {


  constructor(private notoficationService:NotificationServiceService,private formStateService: FormStateService, private httpService: HttpService) { super(); }
  ...
  fetchLovValues(lovName) {
    this.httpService.postData("/customform/data/name/lov", { "lovName": lovName }).subscribe(event => {
      ...
      this.notoficationService.hideProgressBar();
      this.notoficationService.showErrorDialog(error);
    });
  }
  removeSelectedItems() {
