...
import { FormAttachment, WidgetMetaData } from "../../../../shared/shared/models";


@Component({
  selector: 'app-widget-table-attach',
  templateUrl: './widget-table-attach.component.html',
  styleUrls: ['./widget-table-attach.component.scss']
})
export class WidgetTableAttachComponent extends WidgetBase implements OnInit {
