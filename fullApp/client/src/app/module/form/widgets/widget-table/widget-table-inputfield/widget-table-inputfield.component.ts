...
@Component({
  selector: 'app-widget-table-inputfield',
  templateUrl: './widget-table-inputfield.component.html',
  styleUrls: ['./widget-table-inputfield.component.scss']
})
export class WidgetTableInputfieldComponent extends WidgetBase implements OnInit {
