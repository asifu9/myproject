...
@Component({
  selector: 'app-widget-multichoice',
  templateUrl: './widget-multichoice.component.html',
  styleUrls: ['./widget-multichoice.component.scss']
})
export class WidgetMultichoiceComponent extends WidgetBase implements OnInit {
